            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Text(
                        "terakhir terlihat ${lastSeenMessage(user.lastSeen)} yang lalu",
                        style: TextStyle(color: context.theme.greyColor),
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          iconWithText(icon: Icons.call, text: 'Panggilan'),
                          iconWithText(icon: Icons.video_call, text: 'Video'),
                          iconWithText(icon: Icons.search, text: 'Mencari'),
                        ],
                      ),
                    ],
                  ),
                ...
                ListTile(
                  ...
                  title: const Text('Hai! Saya menggunakan aplikasi'),
                  subtitle: Text(
                    '17 Februari',
                    style: TextStyle(
                      color: context.theme.greyColor,
                ...
                const SizedBox(height: 20),
                CustomListTile(
                  title: 'Nonaktifkan pemberitahuan',
                ...
                const CustomListTile(
                  title: 'Enkripsi',
                  subTitle:
                      'Pesan dan panggilan dienkripsi ujung ke ujung, Ketuk untuk memverifikasi.',
                  leading: Icons.lock,
                ),
                const CustomListTile(
                ...
                ListTile(
                  ...
                  title: Text('Buat grup dengan ${user.username}'),
                ),
                const SizedBox(height: 20),
                ListTile(
