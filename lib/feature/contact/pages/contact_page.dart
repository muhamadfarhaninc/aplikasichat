...
class ContactPage extends ConsumerWidget {
  ...
  shareSmsLink(phoneNumber) async {
    Uri sms = Uri.parse(
      "sms:$phoneNumber?body=Mari mengobrol di Aplikasi! ini adalah aplikasi yang cepat, sederhana, dan aman yang dapat kami hubungi satu sama lain secara gratis. Dapatkan di https://whatsapp.com/dl/",
    );
